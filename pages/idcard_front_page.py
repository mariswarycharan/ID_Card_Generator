...
if generate_idcard:
    ...
    front = Image.open(r"images\4958577397a4539.png").convert("RGBA")
    ...
    title_font = ImageFont.truetype(r"Fold style folder\poppins\Poppins-Black.otf",55)
    ...
    title_sub = ImageFont.truetype(r"Fold style folder\poppins\Poppins-Regular.otf",30)

    d1.text((200,70),college_name2,font = title_sub ,fill= (0,0,0))

    sub_font = ImageFont.truetype(r"Fold style folder\poppins\Poppins-Black.otf",35)
    myname_font = ImageFont.truetype(r"Fold style folder\poppins\Poppins-Medium.otf",35)
    ...
    course_font = ImageFont.truetype(r"Fold style folder\poppins\Poppins-Medium.otf",28)
